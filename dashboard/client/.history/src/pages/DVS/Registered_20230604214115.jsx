  ...
  const columns = [
    ...
    },
    {
      ...
      },
      {
        ...
        renderCell: (params) => (
          <img src={params.value} alt="Profile" style={{ width: "100%" }} />
        ),
      },
      {
        field: "pdf",
        ...
        headerClassName: "bg-[#1E293B] text-white text-sm cursor-pointer",
        renderCell: (params) => (
          <button onClick={() => handleDownload(params.value)}>
            Download
          </button>
        ),
      },
    ...
    try {
      ...
      degree.forEach((element, index) => {
        const dd = {
          ...
          cnic:element.cnic_no          ,
          registration_no:element.degree_reg_no,
          passing_year:element.passing_year,
          status:element.status,
          img: element.degreeImage,
          pdf:element.degreePdf
