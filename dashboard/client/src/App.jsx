...
import Applications from './pages/DVS/Applications';
import ApplicatntDetail from './pages/DVS/ApplicantDetail';
import Quries from './pages/DVS/Quries';
import Registered from './pages/DVS/Registered';
...
function App() {
  ...
  return (
    <>
      <Routes>
        {/* Applicants */}
        <Route exact path="/applicants" element={<Applications/>} />
        {/* Detail */}
        <Route exact path="/applicationDetail" element={<ApplicatntDetail/>} />
        {/* quries */}
        <Route exact path="/queries" element={<Quries/>} />
