                  ...
                  <ModalBasic id="feedback-modal" modalOpen={feedbackModalOpen} setModalOpen={setFeedbackModalOpen} title="Send Feedback">
                        ...
                        <div className="px-5 py-4">
                          <div className="text-sm">
                            <div className="font-medium text-slate-800 mb-3">Rejecting the Applicant Request</div>
                          </div>
                          <div className="space-y-3">
                            <div>
                              <label className="block text-sm text-black font-medium mb-1" htmlFor="name">Name </label>
