...
const Quries = () => {
  ...
  const sendFeedback=async()=>{
    try {
      const result=await axios.post(`${import.meta.env.VITE_BACKEND_URL}/adminResponsebymail`,
      {
        queryId:Location.state.id,
  ...
  const DeleteTask = () => {
    ...
    try {
      axios
        .delete(`${import.meta.env.VITE_BACKEND_URL}/adminResponsebymail`, 
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("AuthToken")}`,
          },
