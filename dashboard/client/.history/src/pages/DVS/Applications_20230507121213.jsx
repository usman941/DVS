          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-slate-800 font-bold">Applications</h1>
              </div>
              </div>
...
<div className="flex  flex-row justify-between -mt-4 -mx-4">
                <div className="flex-row items-center justify-center p-2 mb-1 bg-[#CBAA5F]  rounded-2xl text-black ">
