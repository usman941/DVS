export const DVSABis= [
  ...
  {
    inputs: [{ internalType: "uint256", name: "_degreeId", type: "uint256" }],
    name: "getDegree",
    outputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "_pictureHash", type: "string" },
      { internalType: "string", name: "_pdfHash", type: "string" },
      { internalType: "string", name: "_university", type: "string" },
      { internalType: "uint256", name: "_passingYear", type: "uint256" },
    ],
    name: "mintDegree",
    outputs: [],
    stateMutability: "nonpayable",
