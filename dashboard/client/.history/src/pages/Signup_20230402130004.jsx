...
const RegisterNow=()=>{
  if(formdata.name===''||formdata.email===''||formdata.password===''||formdata.confirmPassword==='')
  {
    ...
    SignUp(address,formdata.name,formdata.email,formdata.password,formdata.confirmPassword)
  }
}
  ...
  //   e.preventDefault();
  //   try {
  //     axios.post(`http://localhost:8000/api/v1/user/register`, data).then((res) => {
            ...
            <div className="max-w-sm mx-auto px-4 py-8">
              ...
              <form onSubmit={submitHandler}>
                ...
                <div>
                    ...
                    <input id="email" value={data.email} onChange={(e) => setData({ ...data, email: e.target.value })} className="form-input w-full" type="email" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="email">Email Address <span className="text-rose-500">*</span></label>
                    <input id="email" value={data.email} onChange={(e) => setData({ ...data, email: e.target.value })} className="form-input w-full" type="email" />
                  ...
                  <div>
                    ...
                    <input id="name" value={data.username} onChange={(e) => setData({ ...data, username: e.target.value })} className="form-input w-full" type="text" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="role">Your Role <span className="text-rose-500">*</span></label>
                    <select id="role" className="form-select w-full" onChange={(e) => setData({ ...data, role: e.target.value })}>
                  ...
                  <div>
                    ...
                    <input id="password" value={data.password} onChange={(e) => setData({ ...data, password: e.target.value })} className="form-input w-full" type="password" autoComplete="on" />
                  </div>
                </div>
