      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="justify-center  grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2  gap-y-8 lg:pl-16 xl:pl-16  pl-8 mt-8">

              {/* Card */}
              <div className="  lg:w-[350px] xl:w-[350px] md:w-[270px] w-[300px] bg-[#1A232F] p-6 hover:bg-[#2a2d38] cursor-pointer">
     <div className="flex overflow-hidden  justify-center">
              <img className="hover:scale-110 h-[230px]  " src={bs_degree} />
            </div>
        ...
        {/* 2 */}
        <div className="  lg:w-[350px] xl:w-[350px] md:w-[270px] w-full bg-[#1A232F] p-6 hover:bg-[#2a2d38] cursor-pointer">
