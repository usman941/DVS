...
const Quries = () => {
  ...
  const columns = [
    { field: "id", headerName: "ID", width: 200, headerClassName: "bg-blue-900 text-white text-sm", },
    { field: "query_by", headerName: "Query By", width: 150, headerClassName: "bg-blue-900 text-white text-sm", },
    { field: "query", headerName: "Query", width: 150, headerClassName: "bg-blue-900 text-white text-sm", },
  ];
