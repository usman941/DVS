...
import QuriesResponded from '../partials/dashboard/QuriesResponded';
...
function Dashboard() {
  ...
  const QuriesResp= async()=>{
    try {
      ...
      console.log("getting all Count Quries", result.data);
      setcountQueryResp(result.data.nonNullResponseCount);
